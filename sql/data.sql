...
(39, 5, 'What part is being evaluated:', '', '1', 'text', 1, 22);
...
INSERT INTO rames_feedback_questions (ID, CategoryID, Question, QuestionNr, Type, LanguageID) VALUES
(1, 1, 'How did the plan for evaluation defined by using RAMES work overall?', '1', 'radio', 1),
(2, 1, 'How did the plan for evaluation defined by using RAMES work for the Roles factors overall?', '2a', 'radio', 1),
(3, 1, 'Was there a particular part in the Roles factors that worked badly or very badly?', '2b', 'chekcbox', 1),
(4, 1, 'Describe in few words, why it worked badly or very badly?', '2c', 'text', 1),
(5, 1, 'Was there a particular part in the Roles factors that worked well or very well?', '2d', 'chekcbox', 1),
(6, 1, 'Describe in few words, why it worked well or very well?', '2e', 'text', 1),
(7, 2, 'How did the plan for evaluation defined by using RAMES work for the Activities factors overall?', '3a', 'radio', 1),
(8, 2, 'Was there a particular part in the Roles Activities that worked badly or very badly?', '3b', 'checkbox', 1),
(9, 2, 'Describe in few words, why it worked badly or very badly?', '3c', 'text', 1),
(10, 2, 'Was there a particular part in the Activities factors that worked well or very well?', '3d', 'checkbox', 1),
(11, 3, 'Hoxw did the plan for evaluation defined by using RAMES work for the Material factors overall?', '4a', 'radio', 1),
(12, 3, 'Was there a particular part in the Roles Material that worked badly or very badly?', '4b', 'checkbox', 1),
(13, 3, 'Describe in few words, why it worked badly or very badly?', '4c', 'text', 1),
(14, 3, 'Was there a particular part in the Material factors that worked well or very well?', '4d', 'checkbox', 1),
(15, 4, 'How did the plan for evaluation defined by using RAMES work for the Environment factors overall?', '5a', 'radio', 1),
(16, 4, 'Was there a particular part in the Roles Environment that worked badly or very badly?', '5b', 'checkbox', 1),
(17, 4, 'Describe in few words, why it worked badly or very badly?', '5c', 'text', 1),
(18, 4, 'Was there a particular part in the Environment factors that worked well or very well?', '5d', 'checkbox', 1),
(19, 5, 'How did the plan for evaluation defined by using RAMES work for the System factors overall?', '6a', 'radio', 1),
(20, 5, 'Was there a particular part in the Roles System that worked badly or very badly?', '6b', 'checkbox', 1),
(21, 5, 'Describe in few words, why it worked badly or very badly?', '6c', 'text', 1),
(22, 5, 'Was there a particular part in the System factors that worked well or very well?', '6d', 'checkbox', 1),
(23, 5, 'Is there something that you are definitely going to change next time you do a similar evaluation? ', '7', 'text', 1),
(24, 5, 'Any other comments you would like to store?', '8', 'text', 1);

INSERT INTO question_feedback_checkbox_choices (ID, QuestionID, Choice) VALUES
(1, 3, 'Users'),
(2, 3, 'Evaluators'),
(3, 3, 'Observers'),
(4, 3, 'Recipients'),
...
(9, 8, 'Stating purpose'),
(10, 8, 'Timing'),
(11, 8, 'Conducting evaluation'),
(12, 8, 'Analysing the data'),
(13, 8, 'Making decisions'),
(14, 12, 'Stating purpose'),
(15, 12, 'Timing'),
(16, 12, 'Conducting evaluation'),
(17, 12, 'Analysing the data'),
(18, 12, 'Making decisions'),
(19, 16, 'Stating purpose'),
(20, 16, 'Timing'),
(21, 16, 'Conducting evaluation'),
(22, 16, 'Analysing the data'),
(23, 16, 'Making decisions'),
(24, 21, 'Stating purpose'),
(25, 21, 'Timing'),
(26, 21, 'Conducting evaluation'),
(27, 21, 'Analysing the data'),
(28, 21, 'Making decisions'),
(29, 10, 'Stating purpose'),
(30, 10, 'Timing'),
(31, 10, 'Conducting evaluation'),
(32, 10, 'Analysing the data'),
(33, 10, 'Making decisions'),
(34, 14, 'Stating purpose'),
(35, 14, 'Timing'),
(36, 14, 'Conducting evaluation'),
(37, 14, 'Analysing the data'),
(38, 14, 'Making decisions'),
(39, 18, 'Stating purpose'),
(40, 18, 'Timing'),
