...
exports.generateJWT = function (object) {
	...
	scopes.push('user');
	/* Define the privileges to scopes for api calls in token */
	...
	else if(object.ismoderator === true) {
		scopes.push('moderator');
		scopes.push('reader');
		scopes.push('writer');			
	}
	else if(object.iswriter === true) {
		scopes.push('writer');
		scopes.push('reader');		
	}
	else if(object.isreader === true) {
		scopes.push('reader');		
	}
...
exports.decodeJWT = function (req) {
	...
	var decoded = jwt.verify(token2, secure.secret);
