...
router.get('/api/getAllReceiverType', function (req, res, next) {
	var table = 'receiver_type';
...
router.get('/api/getAllFilterReceiver', function (req, res, next) {
	var table = 'filter_receiver';
